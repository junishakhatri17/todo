  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Customer.tasks.findById() instead.
        "prototype$__findById__tasks": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Customers/:id/tasks/:fk",
          method: "GET"
        },

        // INTERNAL. Use Customer.tasks.destroyById() instead.
        ...
        // INTERNAL. Use Customer.tasks.updateById() instead.
        ...
        // INTERNAL. Use Customer.tasks() instead.
        "prototype$__get__tasks": {
          isArray: true,
          url: urlBase + "/Customers/:id/tasks",
          method: "GET"
        },

        // INTERNAL. Use Customer.tasks.create() instead.
        "prototype$__create__tasks": {
          url: urlBase + "/Customers/:id/tasks",
          method: "POST"
        },

        // INTERNAL. Use Customer.tasks.destroyAll() instead.
        "prototype$__delete__tasks": {
          url: urlBase + "/Customers/:id/tasks",
          method: "DELETE"
        },

        // INTERNAL. Use Customer.tasks.count() instead.
        "prototype$__count__tasks": {
          url: urlBase + "/Customers/:id/tasks/count",
          method: "GET"
        },
        ...
        // INTERNAL. Use Task.user() instead.
        "::get::Task::user": {
          url: urlBase + "/Tasks/:id/user",
          method: "GET"
        },
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Customer.tasks
     * @header lbServices.Customer.tasks
     * @object
     * @description
     *
     * The object `Customer.tasks` groups methods
     * manipulating `Task` instances related to `Customer`.
     *
     * Call {@link lbServices.Customer#tasks Customer.tasks()}
     ...
     */
        ...
        R.tasks = function() {
          ...
          var action = TargetResource["::get::Customer::tasks"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.tasks#count
         * @methodOf lbServices.Customer.tasks
         *
         * @description
         *
         * Counts tasks of Customer.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
        ...
        R.tasks.count = function() {
          var TargetResource = $injector.get("Task");
          var action = TargetResource["::count::Customer::tasks"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.tasks#create
         * @methodOf lbServices.Customer.tasks
         *
         * @description
         *
        ...
        R.tasks.create = function() {
          var TargetResource = $injector.get("Task");
          var action = TargetResource["::create::Customer::tasks"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.tasks#createMany
         * @methodOf lbServices.Customer.tasks
         *
         * @description
         *
        ...
        R.tasks.createMany = function() {
          var TargetResource = $injector.get("Task");
          var action = TargetResource["::createMany::Customer::tasks"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.tasks#destroyAll
         * @methodOf lbServices.Customer.tasks
         *
         * @description
         *
        ...
        R.tasks.destroyAll = function() {
          var TargetResource = $injector.get("Task");
          var action = TargetResource["::delete::Customer::tasks"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.tasks#destroyById
         * @methodOf lbServices.Customer.tasks
         *
         * @description
         *
        ...
        R.tasks.destroyById = function() {
          var TargetResource = $injector.get("Task");
          var action = TargetResource["::destroyById::Customer::tasks"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.tasks#findById
         * @methodOf lbServices.Customer.tasks
         *
         * @description
         *
        ...
        R.tasks.findById = function() {
          var TargetResource = $injector.get("Task");
          var action = TargetResource["::findById::Customer::tasks"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.tasks#updateById
         * @methodOf lbServices.Customer.tasks
         *
         * @description
         *
        ...
        R.tasks.updateById = function() {
          var TargetResource = $injector.get("Task");
          var action = TargetResource["::updateById::Customer::tasks"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Customer.tasks.createMany() instead.
        "::createMany::Customer::tasks": {
          isArray: true,
          url: urlBase + "/Customers/:id/tasks",
          method: "POST"
        },
    ...
    */
    R.modelName = "Task";
        ...
        R.user = function() {
          ...
          var action = TargetResource["::get::Task::user"];
          return action.apply(R, arguments);
        };
